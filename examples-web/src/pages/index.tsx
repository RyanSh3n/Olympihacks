  ...
  return (
    <div className="flex flex-col min-h-screen justify-between">
      <div className="flex flex-col items-center justify-center pt-0 pb-20 px-4 hero"
          style={{background: 'radial-gradient(circle at center, #4338ca50 0%, #667eea00 50%)'}}
      >
        ...
        <div className="mb-10 flex">
          ...
          <button onClick={handleBuyTickets} className="mt-4 px-8 py-3 rounded-md border-2 border-zinc-700 text-white hover:bg-indigo-900 hover:border-indigo-400 text-lg ml-2">Buy Tickets</button>
        </div>
      </div>
