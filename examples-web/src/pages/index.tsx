    ...
    <div className="flex flex-col min-h-screen justify-between">
      <div className="flex flex-col items-center justify-center pt-20 pb-10 px-4">
        ...
        <div className="mb-10 flex">
          <button className="mr-4 px-4 py-2 border-2 border-black font-bold">CREATE EVENT</button>
          <button onClick={handleBuyTickets} className="px-4 py-2 border-2 border-black font-bold">BUY TICKETS</button>
        </div>
      </div>
      <div id="upcomingEvents" className="w-full py-10 px-4 bg-gray-200">
